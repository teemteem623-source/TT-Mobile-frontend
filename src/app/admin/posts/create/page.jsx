...
const CreatePostForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.title || !formData.content) {
            setErrors({ message: "Thiếu data rồi bro 🤨" });
            return;
        }
    ...
    return (
        <div className="max-w-3xl mx-auto p-8 bg-gradient-to-r from-purple-50 via-white to-indigo-50 shadow-2xl rounded-3xl transition-all duration-300">
